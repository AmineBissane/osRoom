...
// GET endpoint to fetch classrooms by category
export async function GET(
  ...
  try {
    ...
    console.log(`Fetching classrooms for category: ${category}`)
    console.log('Using token:', accessToken.substring(0, 20) + '...')

    // Log the full URL for debugging
    const apiUrl = `http://82.29.168.17:8222/api/v1/classrooms/classroom/category/${category}`
